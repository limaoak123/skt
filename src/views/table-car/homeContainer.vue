<template>
  ...
  <section class="channel-floor">
    <h2>精品推荐</h2>
      <ul>
        <li>
          <router-link :to="'/proInfo?'+recommendList[0].prdId">
            <div class="img-area">
        ...
        <li>
          <router-link :to="'/proInfo?'+recommendList[1].prdId">
            <div class="img-area">
              <p class="d-img"><img src="https://res5.vmallres.com/pimages/product/6901443239160/428_428_1539569436793mp.png" alt="" width="100"></p>
              <p class="p-name">{{recommendList[1].prdName}}</p>
              <p class="p-promotion">{{recommendList[1].timerPromWord}}</p>
              <p class="p-price">
                <b>￥{{recommendList[1].prdUnitPrice}}</b>
                <del>￥{{recommendList[1].prdCurrentPrice}}</del>
              </p>
            </div>
          </router-link>
        </li>
         <li>
          <router-link :to="'/proInfo?'+recommendList[2].prdId">
            <div class="img-area">
        ...
        <li>
          <router-link :to="'/proInfo?'+recommendList[3].prdId">
            <div class="img-area">
              <p class="d-img"><img src="https://res5.vmallres.com/pimages/product/6901443184293/428_428_1539767835928mp.png" alt="" width="100"></p>
              <p class="p-name">{{recommendList[3].prdName}}</p>
              <p class="p-promotion">{{recommendList[3].timerPromWord}}</p>
              <p class="p-price">
                <b>￥{{recommendList[3].prdUnitPrice}}</b>
                <del>￥{{recommendList[3].prdCurrentPrice}}</del>
              </p>
            </div>
          </router-link>
        </li>
        <li>
          <router-link :to="'/proInfo?'+recommendList[4].prdId">
            <div class="img-area">
        ...
        <li>
          <router-link :to="'/proInfo?'+recommendList[5].prdId">
            <div class="img-area">
         ...
         <li>
          <router-link :to="'/proInfo?'+recommendList[6].prdId">
            <div class="img-area">
        ...
        <li>
          <router-link :to="'/proInfo?'+recommendList[7].prdId">
            <div class="img-area">
  ...
  <section class="region-area">
    ...
    <div class="phone-img">
      <ul>
        <li>
          <router-link :to="'/proInfo?'+homePhoneList[0].prdId">
            <div class="d-img">
        ...
        <li>
          <router-link :to="'/proInfo?'+homePhoneList[1].prdId">
            <div class="d-img">
      ...
      <ul>
        <li>
          <router-link :to="'/proInfo?'+homePhoneList[2].prdId">
            <div class="d-img">
       ...
       <li>
          <router-link :to="'/proInfo?'+homePhoneList[3].prdId">
            <div class="d-img">
    ...
    <section class="channel-floor" style="margin-top:0">
      <ul>
        <li>
          <router-link :to="'/proInfo?'+homePhoneList[4].prdId">
            <div class="img-area">
       ...
       <li>
          <router-link :to="'/proInfo?'+homePhoneList[5].prdId">
            <div class="img-area">
        ...
        <li>
          <router-link :to="'/proInfo?'+homePhoneList[6].prdId">
            <div class="img-area">
         ...
         <li>
          <router-link :to="'/proInfo?'+homePhoneList[7].prdId">
            <div class="img-area">
        ...
        <li>
          <router-link :to="'/proInfo?'+homePhoneList[8].prdId">
            <div class="img-area">
        ...
        <li>
          <router-link :to="'/proInfo?'+homePhoneList[9].prdId">
            <div class="img-area">
